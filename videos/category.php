...
$tag = $_GET['tag'] ?? '太鼓台';
$videos = get_videos_by_tag($conn, $tag);
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<html>
<head><meta charset="UTF-8"><title>カテゴリ: <?php echo htmlspecialchars($tag); ?></title>
<link rel="stylesheet" type="text/css" href="../style.css">
</head>
<body>
<?php include('../templates/header.php'); include('../templates/nav.php'); ?>
<div class="container">
<h2>カテゴリ: <?php echo htmlspecialchars($tag); ?></h2>
<?php
if(!$videos){ echo "<p>このカテゴリの動画はまだありません。</p>"; }
else{
    foreach($videos as $video){
        ...
        echo "<a href='$url'>".htmlspecialchars($video['title'])."</a> (再生: ".$video['views'].")";
        echo "</div>";
    }
}
?>
